...
public class LoadVocabTest {
  ...
  void testLoadPlainTextVocab() throws IOException {
    final Map<String, Integer> vocab = AbstractDL.loadVocab(getResource("vocab-plain.txt"));
  ...
  void testLoadJsonVocab() throws IOException {
    final Map<String, Integer> vocab = AbstractDL.loadVocab(getResource("vocab.json"));
  ...
  void testJsonVocabWithEscapedCharacters() throws IOException {
    ...
    final Map<String, Integer> vocab = AbstractDL.loadVocab(tempFile);
  ...
  void testJsonVocabRejectsInvalidEscapedCharacters() throws IOException {
    ...
    assertThrows(IllegalArgumentException.class, () -> AbstractDL.loadVocab(tempFile));
  }

  @Test
  void testJsonAndPlainTextVocabProduceSameResult() throws IOException {
    final Map<String, Integer> plainVocab = AbstractDL.loadVocab(getResource("vocab-plain.txt"));
    final Map<String, Integer> jsonVocab = AbstractDL.loadVocab(getResource("vocab.json"));
