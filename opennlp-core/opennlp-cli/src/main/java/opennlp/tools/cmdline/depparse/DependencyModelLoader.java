...
/**
 * Loads a {@link DependencyModel} for the command line tools.
 * <p>
...
public class DependencyModelLoader extends ModelLoader<DependencyModel> {
  ...
  @Override
  protected DependencyModel loadModel(InputStream modelIn) throws IOException {
    return new DependencyModel(modelIn);
  }
