...
public class GlobMatcherTest {
  ...
  private static Stream<TestArguments> acceptedAndRejected() {
   ...
   */
  @Test
  void testAsRegexAgreesWithMatcher() {
    Assertions.assertAll(acceptedAndRejected().map(arguments -> () -> {
      String glob = arguments.string(0);
      String input = arguments.string(1);
  ...
  private static Stream<TestArguments> asRegexGlobs() {
    return Stream.of(
   ...
   */
  @Test
  void testAsRegexTranslatesGlob() {
    Assertions.assertAll(asRegexGlobs().map(arguments -> () -> {
      String glob = arguments.string(0);
