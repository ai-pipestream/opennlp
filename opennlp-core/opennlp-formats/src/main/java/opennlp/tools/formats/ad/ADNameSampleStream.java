...
public class ADNameSampleStream implements ObjectStream<NameSample> {
   ...
   * the text is named by its reference prefix or its source attribute, and the id counts the
   * distinct names seen so far, so it changes when a new text starts (OPENNLP-1951).
   *
