...
into Apache main; #1208 followed on August 17 as `9d224f938`, so all three
fixes now arrive through main and OPENNLP-1906 left the regeneration list.
Fix #1205 is approved and awaiting merge. Also on August 13,
...
glossary loader commits and the installer convergence are now integrated. Exact
integrated tips remain in `PIPESTREAM-PROVENANCE.txt`; the published preview is
always the head of `kristian-3.x-features` on the org fork. Round details and
measurements remain in the workspace-level `QUALITY-PASS.md`.
...
flowchart LR
  ...
  main --> p1205["#1205 · OPENNLP-1903 · APPROVED · BeamSearch chain nodes"]
