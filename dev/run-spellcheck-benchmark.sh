...
module=opennlp-extensions/opennlp-spellcheck
source_file=$root/opennlp-extensions/opennlp-spellcheck/src/jmh/java/opennlp/spellcheck/normalizer/SpellcheckExclusionBenchmark.java
...
exec java -cp "$classes:$classpath" org.openjdk.jmh.Main SpellcheckExclusionBenchmark "$@"
