...
module=opennlp-core/opennlp-formats
source_file=$root/opennlp-core/opennlp-formats/src/jmh/java/opennlp/tools/formats/conllu/ConlluStreamBenchmark.java
...
exec java -cp "$classes:$classpath" org.openjdk.jmh.Main ConlluStreamBenchmark "$@"
